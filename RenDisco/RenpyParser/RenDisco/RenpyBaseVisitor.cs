...
public partial class RenpyBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IRenpyVisitor<Result> {
	/// <summary>
	/// Visit a parse tree produced by <see cref="RenpyParser.script"/>.
	/// <para>
	...
	public virtual Result VisitScript([NotNull] RenpyParser.ScriptContext context) { return VisitChildren(context); }
	/// <summary>
