...
public partial class RenpyBaseListener : IRenpyListener {
	/// <summary>
	/// Enter a parse tree produced by <see cref="RenpyParser.script"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterScript([NotNull] RenpyParser.ScriptContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="RenpyParser.script"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitScript([NotNull] RenpyParser.ScriptContext context) { }
	/// <summary>
